...
* **Use Own Skills:** When making architectural decisions, understanding the specific *business context* of Focus Bear, and during code reviews. I cannot blame AI if I commit code I don't understand.
...
* *Bad:* "Fix this error for user `john@focusbear.io` with password `12345`."
* *Good:* "Fix this error for a generic user object with placeholder credentials."
