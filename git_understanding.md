...
- **Real-world use:**
  ...
  - **Accountability & Debugging:** `git blame` is useful to find out _who_ wrote a complex piece of logic so I can ask them questions, or to check if a recent change corresponds to when a bug started appearing.
...
- **Documentation:** The PR discussion serves as a permanent history of _why_ a change was made.
